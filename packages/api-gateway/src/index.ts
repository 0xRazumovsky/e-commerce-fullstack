...
app.use(
  "/api/products",
  proxy(process.env.PRODUCT_SERVICE_URL || "http://localhost:3002"),
);
app.use(
  "/api/cart",
  authMiddleware,
  proxy(process.env.CART_SERVICE_URL || "http://localhost:3003"),
);
app.use(
  "/api/orders",
  authMiddleware,
  proxy(process.env.ORDER_SERVICE_URL || "http://localhost:3004"),
);
app.use(
  "/api/payments",
  authMiddleware,
  proxy(process.env.PAYMENT_SERVICE_URL || "http://localhost:3005"),
);
